...
class GradingJSONGenerator:
    ...
    def generate_all_json(self) -> bool:
        ...
        self.console.print("🔧 [bold]Generating All Grading JSON Files[/bold]")
        ...
        try:
            ...
            if not items_file.exists():
                self.console.print("⚠️  items.json not found - run parse_items.py first")
            ...
            self.console.print("✅ [bold green]All grading JSON files generated successfully[/bold green]")
            return True
            
        except Exception as e:
            self.console.print(f"❌ Error generating grading JSON: {e}")
            return False
    ...
    def _generate_modules_json(self) -> bool:
        ...
        if not modules_yml.exists():
            self.console.print(f"⚠️  modules.yml not found: {modules_yml}")
        ...
        self.console.print(f"✅ Generated modules.json: {len(modules_list)} modules")
        return True
    ...
    def _generate_constituents_json(self) -> bool:
        ...
        if not constituents_yml.exists():
            self.console.print(f"⚠️  constituents.yml not found: {constituents_yml}")
        ...
        self.console.print(f"✅ Generated constituents.json: {len(constituents_list)} constituents")
        return True
...
def main():
    ...
    console.print(f"🚀 [bold]Grading JSON Generator[/bold]")
    ...
    if success:
        console.print("\\n✅ [bold green]All grading JSON files generated successfully[/bold green]")
        return 0
    else:
        console.print("\\n❌ [bold red]Grading JSON generation failed[/bold red]")
        return 1
